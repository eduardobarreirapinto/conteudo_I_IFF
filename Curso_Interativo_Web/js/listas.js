...
var conteudo6 = document.getElementById('conteudo6');
...
botao6.addEventListener('click',fica_6,false);


var gabarito;
var lista = [];
var ul_lista = document.getElementById('ul_lista');
var respostas = ["['Eu', 'Fui', True]" , "['Eu', 'Fui']" ,"[0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 ]","[ 1 , 'Eu', 'Fui']",'Nenhuma das respostas anteriores'];
...
function fica_1() {
    ...
    botao6.classList.add("nao-clicado");
    botao6.classList.remove("clicado");
...
function fica_2() {
 ...
 function fica_6() {
  ...
  conteudo4.remove();
  conteudo5.remove();
  conteudo6.classList.add("aparecer");
  botao1.classList.add("nao-clicado");
  botao1.classList.remove("clicado");
  botao2.classList.add("nao-clicado");
  botao2.classList.remove("clicado");
  ...
  botao5.classList.add("nao-clicado");
  botao5.classList.remove("clicado");
  botao6.classList.add("clicado");
  botao6.classList.remove("nao-clicado");
  conteudo_container.appendChild(conteudo6);
