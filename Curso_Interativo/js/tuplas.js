...
var respostas = ['soma(soma(vezes(a, potencia2(x)), vezes(b, x)), c)', 'soma(soma(potencia2(a, vezes(x)), vezes(b, x)), c)','soma(potencia2(a,vezes(x)),vezes(b,x)),c','soma(vezes(a,potencia2(x),vezes(b,x)),c)','Nenhuma das respostas anteriores'];
