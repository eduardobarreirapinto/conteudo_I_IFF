...
var respostas = ['Uma cobra venenosa.', 'Um grupo de comédia.','Uma linguagem de programação','O pai do Thon.','Nenhuma das respostas anteriores'];
...
function verificar_resposta(){
  if(this.innerHTML=='Uma linguagem de programação'){
