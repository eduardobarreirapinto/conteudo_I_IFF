...
var respostas = ['// Este é um comentário', '<!-- Este é um comentário -->','/* Este é um comentário */','# Este é um comentário','Nenhuma das respostas anteriores'];
...
function verificar_resposta(){
  if(this.innerHTML=='# Este é um comentário'){
