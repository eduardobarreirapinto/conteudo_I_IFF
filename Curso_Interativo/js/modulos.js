...
var conteudo5 = document.getElementById('conteudo5');
...
botao5.addEventListener('click', fica_5, false);

var gabarito;
var lista = [];
var ul_lista = document.getElementById('ul_lista');
var respostas = ['Comentário é a forma como o programador insere lembretes em um código para lembrar posteriormente.', 'Comentário é um recurso que permite ao programador documentar o código, explicando seu funcionamento e intenção.', 'Comentário é um tipo de função em Python que executa tarefas específicas dentro do código.', 'Comentário é um recurso que permite ao usuário final do programa inserir feedbacks sobre o funcionamento do software.', 'Nenhuma das respostas anteriores'];
...
function fica_1() {
    ...
    botao5.classList.add("nao-clicado");
    botao5.classList.remove("clicado");
...
function fica_5() {
    ...
    conteudo3.remove();
    conteudo4.remove();
    conteudo5.classList.add("aparecer");
    botao1.classList.add("nao-clicado");
    botao1.classList.remove("clicado");
    botao2.classList.add("nao-clicado");
    botao2.classList.remove("clicado");
    ...
    botao4.classList.add("nao-clicado");
    botao4.classList.remove("clicado");
    botao5.classList.add("clicado");
    botao5.classList.remove("nao-clicado");
    conteudo_container.appendChild(conteudo5);
...
function verificar_resposta() {
    if (this.innerHTML == 'Comentário é um recurso que permite ao programador documentar o código, explicando seu funcionamento e intenção.') {
