...
var respostas = ['Pode entrar na festa !!!', 'Entrei de penetra !!!' ,'Barrado no baile !!!','Não pode entrar menor de 18 !!!','Nenhuma das respostas anteriores'];
...
function verificar_resposta(){
  if(this.innerHTML=='Entrei de penetra !!!'){
